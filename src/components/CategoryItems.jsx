  ...
  return (
    <container class="md:flex md:grid-cols-3 p-8 sm:grid sm:grid-cols-1 justify-center">
        <card1 
          ...
          <div class="flex flex-col bg-opacity-60 bg-white md:h-full justify-between py-8 -m-3 h-96">
      ...
      <card2 
        class="md:w-1/4 md:h-96 bg-kids bg-no-repeat bg-cover bg-center flex flex-col justify-center mx-8 my-4 shadow-sm shadow-teal-900 px-6 bg-slate-100 rounded-lg">
